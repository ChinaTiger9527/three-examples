export const examples = [
  {
    ...
    slug: 'basic-scene',
    name: '基础场景',
    file: 'src/examples/01-basic-scene/index.js',
    note: '初始化场景、相机与渲染器。',
  ...
  },
  {
    ...
    slug: 'orbit-controls',
    name: 'OrbitControls',
    file: 'src/examples/02-orbit-controls/index.js',
    note: '相机轨道控制器交互。',
  ...
  },
  {
    ...
    name: '全屏渲染',
    file: 'src/examples/03-fullscreen-render/index.js',
    note: '视口铺满屏幕与尺寸同步。',
  ...
  },
  {
    ...
    slug: 'geometries',
    name: '几何体',
    file: 'src/examples/04-geometries/index.js',
  ...
  },
  {
    ...
    slug: 'materials',
    name: '材质',
    file: 'src/examples/05-materials/index.js',
    note: '常见材质、贴图与环境效果。',
  ...
  },
  {
    ...
    slug: 'text',
    name: '文字',
    file: 'src/examples/06-text/index.js',
  ...
  },
  {
    ...
    slug: 'lights-shadows',
    name: '光源和阴影',
    file: 'src/examples/07-lights-shadows/index.js',
    note: '灯光系统和阴影配置。',
  ...
  },
  {
    ...
    slug: 'particles',
    name: '粒子',
    file: 'src/examples/08-particles/index.js',
    note: '粒子系统与随机分布。',
